...
class DualBrowserPage extends StatefulWidget {
  const DualBrowserPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DualBrowserPageState createState() => _DualBrowserPageState();
}

class _DualBrowserPageState extends State<DualBrowserPage> {
