...
class RecordSplitFrontCamers extends StatefulWidget {
  const RecordSplitFrontCamers({super.key});

  @override
  State<RecordSplitFrontCamers> createState() => _RecordSplitFrontCamersState();
}

class _RecordSplitFrontCamersState extends State<RecordSplitFrontCamers> {
  late CameraController _cameraController;
  late List<CameraDescription> cameras;
  // ignore: unused_field
  late WebViewController _webViewController;
  bool showCamera = true; // Indicates whether to show the camera or map
  bool isRecording = false; // Indicates whether the camera is recording
